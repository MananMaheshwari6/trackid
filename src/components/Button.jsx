...
export default function Button({
  ...
  const baseStyle = 'px-7 py-3 min-h-[44px] rounded-full text-sm font-body font-medium transition-colors duration-200 inline-flex items-center justify-center';
